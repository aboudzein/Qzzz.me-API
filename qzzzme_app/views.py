...
# local imports
from qzzzme_app.models import User, Projects
from qzzzme_app.serializers import (UserCreateSerializer,
                                    UserListSerializer,
                                    ProjectsCreateSerializer,
                                    ProjectsListSerializer)
from qzzzme_app.utils import generate_jwt_token
from qzzzme_app.tasks import add
