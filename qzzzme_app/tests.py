...
from qzzzme_app.models import User
from qzzzme_app.serializers import UserListSerializer, UserCreateSerializer
...
#         self.URLS = {
#                     'register-api': reverse('qzzzme_app-api:register-api'),
#                     'login-api': reverse('qzzzme_app-api:login-api'),
#                     'user-api': reverse('qzzzme_app-api:user-api'),
#                     'project-api': reverse('qzzzme_app-api:project-api'),
#                      }
